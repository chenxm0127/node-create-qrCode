 ...
 * 参数 destImg(string) 目的存储路径 
 * 参数 callback(Function) 
 */  
exports.addWater = function(sourceImg, waterImg, destImg, callback){  
    images(sourceImg)                     //Load image from file   
                                            //加载图像文件  
        .size(400)                          //Geometric scaling the image to 400 pixels width  
                                            //等比缩放图像到400像素宽  
        .draw(images(waterImg), 135, 60)   //Drawn logo at coordinates (70,260)//为了遮住不该看的东西..  
                                            //在(10,10)处绘制Logo  
        .save(destImg, {               //Save the image to a file,whih quality 50  
